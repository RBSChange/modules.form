...
class PHPTAL_Php_Attribute_CHANGE_captcha extends PHPTAL_Php_Attribute
{
    public function start()
    {
        ...
        {
        	case 'img' :
        		$this->tag->generator->doEcho('PHPTAL_Php_Attribute_CHANGE_captcha::renderImage('.var_export($this->tag->attributes, true).', '.var_export($parameters, true).')');
        		break;
        	case 'input' :
        		$this->tag->generator->doEcho('PHPTAL_Php_Attribute_CHANGE_captcha::renderInput('.var_export($this->tag->attributes, true).')');
        		break;
        }
    }
